...
- [#5616](https://github.com/assistant-ui/assistant-ui/pull/5616) [`0034211`](https://github.com/assistant-ui/assistant-ui/commit/0034211a143c809cc11d57752196131d5844aeee) - fix: isolate custom MCP servers across storage scopes and fence writes after load failures ([@Kinfe123](https://github.com/Kinfe123))

- [#7270](https://github.com/assistant-ui/assistant-ui/pull/7270) [`a32a023`](https://github.com/assistant-ui/assistant-ui/commit/a32a023f9300ec55fa9cb6d2251a33688e51328c) - fix: reject OAuth discovery hosts that only resemble loopback addresses ([@Kinfe123](https://github.com/Kinfe123))

- [#7290](https://github.com/assistant-ui/assistant-ui/pull/7290) [`eeead38`](https://github.com/assistant-ui/assistant-ui/commit/eeead385ff926685f23cd32b8626bc6c47d0c25c) - fix: associate MCP add-server form labels and validation errors with their controls ([@rupic-app](https://github.com/apps/rupic-app))
...
- [#6953](https://github.com/assistant-ui/assistant-ui/pull/6953) [`6a325f7`](https://github.com/assistant-ui/assistant-ui/commit/6a325f7ce2a8c0c5de8bd118ed1095feef84a99c) - fix: keep static OAuth client updates out of the dynamic registration cache ([@ephraimduncan](https://github.com/ephraimduncan))

- [#6972](https://github.com/assistant-ui/assistant-ui/pull/6972) [`ec36a7c`](https://github.com/assistant-ui/assistant-ui/commit/ec36a7c6c65db604476ed3e1bd53352ed5d68c9a) - Scope persisted OAuth tokens and client registrations to their originating client. Credentials stored by earlier versions carry no client identity, so they are dropped on first load and every existing OAuth connection re-authenticates once. ([@rupic-app](https://github.com/apps/rupic-app))
