...
- [#7382](https://github.com/assistant-ui/assistant-ui/pull/7382) [`9754825`](https://github.com/assistant-ui/assistant-ui/commit/9754825e7088f692a0f5e310b78b64a4eba7c32b) - fix: normalize nested snake_case media fields in ADK streams and session history. ([@Kinfe123](https://github.com/Kinfe123))

- [#7381](https://github.com/assistant-ui/assistant-ui/pull/7381) [`c3cfdaf`](https://github.com/assistant-ui/assistant-ui/commit/c3cfdafbd5acf6d99d537ac8c709b9d825cc2b17) - fix: preserve failed tool result status in ADK requests, optimistic messages, and session history. ([@Kinfe123](https://github.com/Kinfe123))

- [#7341](https://github.com/assistant-ui/assistant-ui/pull/7341) [`aa97388`](https://github.com/assistant-ui/assistant-ui/commit/aa973884adf4e1e87677adeeb0edb48f443afe47) - fix: wrap scalar tool results in ADK function response objects ([@Kinfe123](https://github.com/Kinfe123))

- [#7401](https://github.com/assistant-ui/assistant-ui/pull/7401) [`622f6a3`](https://github.com/assistant-ui/assistant-ui/commit/622f6a3e402b9ee3278bcf9112164b2b3b5768f0) - fix: drop long-running tool calls the client already answered from `useAdkLongRunningToolIds` and session snapshots ([@rupic-app](https://github.com/apps/rupic-app))

- [#7423](https://github.com/assistant-ui/assistant-ui/pull/7423) [`5ed8c89`](https://github.com/assistant-ui/assistant-ui/commit/5ed8c89aa5e538d3b28e97686ea2249b2b9a0a27) - fix: keep unanswered long-running tool calls in `useAdkLongRunningToolIds` across sends, so answering one gate no longer lets the next text message auto-cancel the others. `AdkEventAccumulator` takes the pending ids to seed as an optional second constructor argument. ([@rupic-app](https://github.com/apps/rupic-app))
...
- [#7160](https://github.com/assistant-ui/assistant-ui/pull/7160) [`5489abc`](https://github.com/assistant-ui/assistant-ui/commit/5489abc3ae47fca15c21f70ff2fce398b3772ac1) - fix: preserve prototype-named session and artifact delta keys ([@Kinfe123](https://github.com/Kinfe123))

- [#6997](https://github.com/assistant-ui/assistant-ui/pull/6997) [`9e92184`](https://github.com/assistant-ui/assistant-ui/commit/9e921843839459187f4a85de2c197a8e811fbe4e) - fix: preserve prototype-named ADK state keys and stabilize namespaced state hooks ([@Kinfe123](https://github.com/Kinfe123))

- [#7162](https://github.com/assistant-ui/assistant-ui/pull/7162) [`bc30174`](https://github.com/assistant-ui/assistant-ui/commit/bc30174eff911817188dc28e08b73927e2f85276) - fix(react-google-adk): validate event content parts ([@Kinfe123](https://github.com/Kinfe123))
...
- [#6412](https://github.com/assistant-ui/assistant-ui/pull/6412) [`0c04eda`](https://github.com/assistant-ui/assistant-ui/commit/0c04eda086a6aad45c5d65b8731c9d66b22f8c3a) - refactor: move the pure adk helpers to the converter seam. ([@okisdev](https://github.com/okisdev))
...
- [#5901](https://github.com/assistant-ui/assistant-ui/pull/5901) [`4390880`](https://github.com/assistant-ui/assistant-ui/commit/4390880b6efbd82dfe3452b819e69877e99f6a17) - fix: answer ADK tool confirmations through the core tool-approval seam instead of writing a fabricated tool result, and replay client-supplied tool results when a thread is reloaded ([@samdickson22](https://github.com/samdickson22))
...
- [#5853](https://github.com/assistant-ui/assistant-ui/pull/5853) [`8169942`](https://github.com/assistant-ui/assistant-ui/commit/816994232cc8310f2bab82e0d47c61b8a08c0e42) - fix: validate Google ADK proxy request payloads ([@Kinfe123](https://github.com/Kinfe123))

- [#6028](https://github.com/assistant-ui/assistant-ui/pull/6028) [`9f2427a`](https://github.com/assistant-ui/assistant-ui/commit/9f2427a12ce59ca13fb70d456b55a7cd9be0ed3f) - fix: validate events loaded from Google ADK session history ([@Kinfe123](https://github.com/Kinfe123))
...
- [#5853](https://github.com/assistant-ui/assistant-ui/pull/5853) [`8169942`](https://github.com/assistant-ui/assistant-ui/commit/816994232cc8310f2bab82e0d47c61b8a08c0e42) - fix: validate Google ADK stream event payloads ([@Kinfe123](https://github.com/Kinfe123))

- [#6000](https://github.com/assistant-ui/assistant-ui/pull/6000) [`6467817`](https://github.com/assistant-ui/assistant-ui/commit/64678170c029c0fc992f4ad767fcdbb034a63999) - fix(react-google-adk): cancel active streams on runtime teardown ([@Kinfe123](https://github.com/Kinfe123))
...
- [#5092](https://github.com/assistant-ui/assistant-ui/pull/5092) [`e18eb87`](https://github.com/assistant-ui/assistant-ui/commit/e18eb871ba368ce72c4fd5f97804e83f91552439) - fix: validate Google ADK artifact API responses ([@Kinfe123](https://github.com/Kinfe123))
